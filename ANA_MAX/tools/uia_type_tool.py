...
class UiaTypeTool(Tool):
    ...
    def execute(self, **kwargs: Any) -> ToolResult:
        ...
        if not kwargs.get("element_title") and not kwargs.get("auto_id") and not kwargs.get("control_type"):
            return ToolResult(status=ToolStatus.ERROR, error="element_title, auto_id or control_type is required")
